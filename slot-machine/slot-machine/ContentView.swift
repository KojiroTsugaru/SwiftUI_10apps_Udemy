            ...
            VStack(alignment: .center, spacing: 80){
                ...
                Button {
                    ...
                    RoundedRectangle(cornerRadius: 10)
                        ...
                        .shadow(color: .gray, radius: 1, x: 1, y: 3)
                }
            ...
            .alert(item: $showingAlert) { alert -> Alert in
                ...
                case .success:
                    return Alert(title: Text("Yahhh! You Won!"), message:
                                    Text("Born with the charm"), dismissButton: .cancel())
                case .failure:
                    return Alert(title: Text("Oooppppsss!"), message:
                                    Text("Better luck next time"), dismissButton: .cancel())
                }
            }
        }
    }
